...
1. Sign in to your [Dashboard](https://homeservicedata.org/dashboard).
...
Operational headers are included on API responses so you can correlate logs and diagnose slow or limited requests:

```
X-HSD-Request-Id: req_01J...
X-HSD-API-Version: 2026-06-30
X-HSD-Duration-Ms: 42
X-HSD-Performance-State: ok
```
