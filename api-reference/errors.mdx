...
<ResponseField name="meta" type="object | null">
  Request metadata useful for support and debugging. Auth, entitlement, and route errors normally include `request_id`, `api_version`, trust metadata, and performance budget metadata. Some low-level framework errors may not include this envelope.
</ResponseField>
